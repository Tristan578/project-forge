...
| Metric | Value |
|--------|-------|
| MCP commands | 358 across 41 categories (289 public), measured 2026-09-05 with `jq '.commands \| length' mcp-server/manifest/commands.json` — per-category status in the [capability matrix](docs/capability-matrix.md) |
