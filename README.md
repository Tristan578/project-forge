...
- **PBR Materials** — Physically-based rendering with metallic/roughness workflow, texture support, and alpha modes
...
| Layer | Technology |
|-------|-----------|
| Engine | Bevy 0.16, wgpu 24, bevy_rapier3d, bevy_hanabi, bevy_panorbit_camera |
