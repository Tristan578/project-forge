...
function Leaf({ style }: LeafProps) {
  return (
    ...
    >
      {/* Simple leaf shape */}
      <path d="M12 2C6.5 2 2 6.5 2 12c0 3.5 1.8 6.6 4.5 8.5C8 21.5 10 22 12 22c5.5 0 10-4.5 10-10S17.5 2 12 2zm0 18c-1.7 0-3.3-.5-4.6-1.4C5.6 17 4 14.6 4 12c0-4.4 3.6-8 8-8 4.4 0 8 3.6 8 8s-3.6 8-8 8z" />
      <path d="M12 4C8.1 4 4.8 7 4.1 11c.9-.6 2-1 3.1-1 3.3 0 6 2.7 6 6 0 1.1-.3 2.2-1 3.1C16 18.4 20 15 20 12c0-4.4-3.6-8-8-8z" />
    </svg>
  );
}

const LEAF_CONFIGS: Array<{ startStyle: React.CSSProperties; animName: string }> = [
  {
