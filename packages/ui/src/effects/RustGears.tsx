/**
 * RustGears — CSS rotate animation on inline SVG gears for the rust theme.
 * 4 small gears positioned on panel dividers, semi-transparent. Pure CSS, no JS.
 */
...
function Gear({ size, style, duration, direction = 'cw' }: GearProps) {
...
export default function RustGears() {
  return (
    <>
      ...
      <Gear size={14} duration={25} direction="ccw" style={{ bottom: '15%', right: '1.5%' }} />
      {/* Mid-left gear */}
      <Gear size={12} duration={15} direction="cw"  style={{ top: '50%', left: '0.5%' }} />
      {/* Top-right gear */}
      <Gear size={13} duration={30} direction="ccw" style={{ top: '25%', right: '1%' }} />
    </>
  );
}
