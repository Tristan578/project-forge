        ...
        <div className="relative flex items-center justify-center">
          ...
          <label
            ...
            className={cn(
              ...
              "bg-[var(--sf-bg-app)]",
              "shadow-[inset_0_1px_2px_rgba(0,0,0,0.2),0_0_0_1px_color-mix(in_srgb,var(--sf-accent)_15%,transparent)]",
              ...
              "hover:border-[color-mix(in_srgb,var(--sf-accent)_60%,var(--sf-border-strong))]",
