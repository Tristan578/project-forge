...
export function TreeView({ nodes, selectedId, onSelect, expandedIds: controlledExpandedIds, onToggleExpand: controlledOnToggle, className, }) {
    ...
    return (_jsx("div", { role: "tree", className: cn('text-xs', className), style: { color: 'var(--sf-text)' }, children: nodes.map((node) => (_jsx(TreeItem, { node: node, depth: 0, ...(selectedId !== undefined && { selectedId }), expandedIds: expandedSet, ...(onSelect !== undefined && { onSelect }), onToggleExpand: handleToggle }, node.id))) }));
}
