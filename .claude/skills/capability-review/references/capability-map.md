...
- We currently wire: Checkout, subscriptions (4 tiers), webhooks, atomic-CTE refunds, customer portal. SDK `22.x`, API `2026-07-29.dahlia` (pinned literal in `stripe-client.ts`).
