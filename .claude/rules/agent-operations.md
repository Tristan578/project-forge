...
Hooks with non-trivial logic get a co-located bash test under `.claude/hooks/__tests__/`.
The full conventions (running the suites, the shellcheck scope, fixture seams, self-re-exec
