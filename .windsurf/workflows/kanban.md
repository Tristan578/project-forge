...
The taskboard is the single source of truth for all project work. It uses an MCP server connected to Claude Code at `http://localhost:3010/api` (Project ID: `01KMM9ZA6SBZ7RKJZJTZS9VR4R`).
