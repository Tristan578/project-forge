...
export const metadata: Metadata = {
  ...
  description: 'GenForge Terms of Service - AI-Powered Game Creation Platform',
};
  ...
  return (
    ...
    >
      ...
      <section id="acceptance">
        ...
        <p>
          By accessing or using GenForge (&quot;the Service&quot;), operated by GenForge
      ...
      <section id="description">
        ...
        <p>
          GenForge is a web-based, AI-powered game creation platform that allows users
      ...
      <section id="subscriptions">
        ...
        <p>
          GenForge offers both free and paid subscription tiers. By subscribing to a
      ...
      <section id="user-content">
        ...
        <h3>5.1 Ownership</h3>
        <p>
          You retain all ownership rights to the content you create using GenForge,
          including game projects, scripts, scene configurations, and any original
          assets you upload (&quot;User Content&quot;). GenForge does not claim ownership of
          your User Content.
        </p>

        <h3>5.2 License to GenForge</h3>
        <p>
          By uploading or creating User Content on the Service, you grant GenForge a
        ...
        <p>
          When you publish a game through GenForge&apos;s cloud publishing feature, you
          grant GenForge the right to host and serve that game to end users at the
      ...
      <section id="ai-content">
        ...
        <p>
          Content generated by AI features within GenForge (including but not limited to
        ...
        <p>
          ...
          providers. GenForge is not responsible for the output or behavior of
        ...
        <p>
          ...
          provider&apos;s terms of service. GenForge encrypts stored API keys but is not
      ...
      <section id="intellectual-property">
        ...
        <p>
          ...
          and functionality, is owned by GenForge and is protected by international
          copyright, trademark, patent, trade secret, and other intellectual property
          laws.
        </p>
        <p>
          The GenForge name, logo, and all related names, logos, product and service
          names, designs, and slogans are trademarks of GenForge. You may not use such
        ...
        <p>
          ...
          remain the exclusive property of GenForge.
        </p>
      </section>
      ...
      <section id="third-party">
        ...
        <p>
          ...
          service and privacy policies. GenForge is not responsible for the practices or
      ...
      <section id="disclaimers">
        ...
        <p>
          GenForge does not warrant that the Service will be uninterrupted, secure,
          or error-free; that defects will be corrected; or that the Service or the
          servers that make it available are free of viruses or other harmful components.
        </p>
        <p>
          Games created and exported through GenForge are provided without warranty.
          GenForge does not guarantee the performance, compatibility, or functionality
      ...
      <section id="limitation">
        ...
        <p>
          ...
          GENFORGE, ITS DIRECTORS, EMPLOYEES, PARTNERS, AGENTS, SUPPLIERS, OR
        ...
        <p>
          IN NO EVENT SHALL GENFORGE&apos;S TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING
          FROM OR RELATING TO THE SERVICE EXCEED THE AMOUNT YOU HAVE PAID TO GENFORGE
      ...
      <section id="indemnification">
        ...
        <p>
          You agree to defend, indemnify, and hold harmless GenForge and its officers,
      ...
      <section id="contact">
        ...
        <ul>
          <li>
            <strong>Email:</strong> legal@genforge.com
          </li>
          <li>
