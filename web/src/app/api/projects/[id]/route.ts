...
>>>>>>> 381bb161 (Add Sentry captureException to moderation, openapi, play, projects, and publish routes (batch 6))
    ...
    captureException(err, { route: '/api/projects/[id]', method: 'GET' });
...
>>>>>>> 381bb161 (Add Sentry captureException to moderation, openapi, play, projects, and publish routes (batch 6))
    ...
    captureException(err, { route: '/api/projects/[id]', method: 'PUT' });
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
>>>>>>> 381bb161 (Add Sentry captureException to moderation, openapi, play, projects, and publish routes (batch 6))
    ...
    captureException(err, { route: '/api/projects/[id]', method: 'DELETE' });
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
