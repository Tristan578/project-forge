...
async function GET_impl(request: NextRequest) {
  ...
  // runs for POST /api/generate/pixel-art (panel 'generate-pixel-art'), BEFORE any
  // provider key is resolved — this route calls `resolveApiKey` directly.
  const tierDenied = panelTierGateResponse('generate-pixel-art', mid.authContext!.user);
