 ...
 * \u{1F1F8}`), keycaps (`1️⃣`) and bare skin-tone modifiers through,
 * each measured reaching jsDelivr with the rest of the card already sanitised.
 *
 ...
 * `⃣` is removed here, so a digit can never form one.
 *
 ...
 */
const EMOJI =
  /\p{Extended_Pictographic}|\p{Emoji_Modifier}|\p{Regional_Indicator}|[\u{FE0F}\u{20E3}\u{200D}]|[\u{E0020}-\u{E007F}]/gu;
