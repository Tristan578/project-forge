...
describe('Arabic play-card paragraph flow', () => {
  it.each(['مغامرة النجوم', 'مغامرة النجوم في السماء الواسعة', 'مغامرة النجوم 123'])('keeps logical words while placing and wrapping from the right: %s', text => {
    ...
    expect(paragraph.props.children.every(word => word.props.style.whiteSpace === 'pre' && word.props.style.flexShrink === 0)).toBe(true);
