...
function makeMockStore(overrides?: Partial<EditorState>): EditorState {
  return {
    ...
    postProcessing: {
      bloom: { enabled: false, intensity: 0.15, lowFrequencyBoost: 0.7, lowFrequencyBoostCurvature: 0.95, highPassFrequency: 1.0, prefilterThreshold: 0.0, prefilterThresholdSoftness: 0.0, compositeMode: 'energy_conserving' as const, maxMipDimension: 512 },
    ...
    defaultTransition: { type: 'fade' as const, duration: 500, color: '#000000', easing: 'ease-in-out' as const },
    qualityPreset: 'high',
    terrainData: {},
    allGameComponents: {},
    ...
    mobileTouchConfig: { enabled: false, autoDetect: true, preset: 'platformer', joystick: null, buttons: [], preferredOrientation: 'any' as const, autoReduceQuality: false },
    hudElements: [],
    ...
    updateBloom: vi.fn(),
    updateChromaticAberration: vi.fn(),
    updateColorGrading: vi.fn(),
    updateSharpening: vi.fn(),
    updateSsao: vi.fn(),
    updateDepthOfField: vi.fn(),
