...
describe('dialogueStore', () => {
  ...
  describe('tree CRUD', () => {
    it('addTree creates tree with start node', () => {
      ...
      expect(tree).toEqual(expect.objectContaining({ name: 'Test Tree' }));
    ...
    it('removeTree deletes tree', () => {
      const treeId = useDialogueStore.getState().addTree('Test Tree');
      expect(useDialogueStore.getState().dialogueTrees[treeId]).toEqual(expect.objectContaining({ name: 'Test Tree' }));
  ...
  describe('persistence', () => {
    it('saveToLocalStorage persists trees', () => {
      ...
      expect(parsed[treeId]).toEqual(expect.objectContaining({ name: 'Persistent Tree' }));
