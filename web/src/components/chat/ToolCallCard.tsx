...
const TOOL_LABELS: Record<string, string> = {
  ...
  set_reverb_zone: 'Set Reverb Zone',
  remove_reverb_zone: 'Remove Reverb Zone',
  set_music_intensity: 'Set Music Intensity',
  set_music_stems: 'Configure Music Stems',
  ...
  set_completion_mode: 'Set Completion Mode',
  ...
  get_sprite_generation_status: 'Sprite Generation Status',
  generate_game_ideas: 'Generate Game Ideas',
  get_idea_details: 'Get Idea Details',
  start_from_idea: 'Start from Idea',
  remix_idea: 'Remix Idea',
