...
describe('QuickStartFlow', () => {
  ...
  it('renders step 1 (game type selection) on first render', () => {
    ...
    expect(screen.getByText('What kind of game?')).toBeTruthy();
  ...
  it('advances to step 2 when a game type card is selected', () => {
    ...
    expect(platformerBtn).toBeTruthy();
    fireEvent.click(platformerBtn!);

    expect(screen.getByText('Describe your game')).toBeTruthy();
    expect(screen.getByText(/Step 2 of 3/)).toBeTruthy();
    expect(screen.getByLabelText('Describe your game in one sentence')).toBeTruthy();
  });
  ...
  it('generates the game and advances to step 3 when Generate is clicked', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Your game is ready!')).toBeTruthy();
    });
