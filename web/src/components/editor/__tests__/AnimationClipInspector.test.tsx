...
describe('AnimationClipInspector', () => {
  ...
  it('shows Add Animation Clip button when no clip', () => {
    ...
    expect(screen.getByText('Add Animation Clip')).toBeInTheDocument();
  });
  ...
  it('renders autoplay checkbox', () => {
    setupStore();
    render(<AnimationClipInspector />);
    expect(screen.getByText('Autoplay in Play mode')).toBeInTheDocument();
  ...
  it('renders Remove Animation Clip button', () => {
    setupStore();
    render(<AnimationClipInspector />);
    expect(screen.getByText('Remove Animation Clip')).toBeInTheDocument();
  });
