...
describe('DialogueTreeEditor', () => {
  ...
  it('renders Dialogue Editor header', () => {
    ...
    expect(screen.getByText('Dialogue Editor')).not.toBeNull();
  });
  ...
  it('shows empty state when no tree selected', () => {
    ...
    render(<DialogueTreeEditor />);
    expect(screen.getByText(/Select or create/)).not.toBeNull();
  });
  ...
  it('shows tree name in dropdown', () => {
    setupStore();
    render(<DialogueTreeEditor />);
    expect(screen.getByText('Main Quest')).not.toBeNull();
  });
  ...
  it('renders tree name input', () => {
    setupStore();
    render(<DialogueTreeEditor />);
    expect(screen.getByText('Tree Name')).not.toBeNull();
  ...
  it('renders text node with label', () => {
    ...
    expect(screen.getByText(/Hello traveler, welcome to the village/)).not.toBeNull();
  });

  it('renders choice node with choice count', () => {
    setupStore();
    render(<DialogueTreeEditor />);
    expect(screen.getByText('2 choices')).not.toBeNull();
  });
  ...
  it('opens add node menu on click', () => {
    ...
    expect(screen.getByText('text Node')).not.toBeNull();
    expect(screen.getByText('choice Node')).not.toBeNull();
    expect(screen.getByText('condition Node')).not.toBeNull();
    expect(screen.getByText('action Node')).not.toBeNull();
    expect(screen.getByText('end Node')).not.toBeNull();
  });
