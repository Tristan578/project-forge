...
describe('MobileToolbar', () => {
  ...
  it('renders Scene Hierarchy toggle button', () => {
    ...
    expect(screen.getByTitle('Scene Hierarchy')).not.toBeNull();
  });

  it('renders Inspector toggle button', () => {
    render(<MobileToolbar onToggleLeft={mockOnToggleLeft} onToggleRight={mockOnToggleRight} />);
    expect(screen.getByTitle('Inspector')).not.toBeNull();
  });
  ...
  it('renders Move gizmo button', () => {
    render(<MobileToolbar onToggleLeft={mockOnToggleLeft} onToggleRight={mockOnToggleRight} />);
    expect(screen.getByTitle('Move')).not.toBeNull();
  });

  it('renders Rotate gizmo button', () => {
    render(<MobileToolbar onToggleLeft={mockOnToggleLeft} onToggleRight={mockOnToggleRight} />);
    expect(screen.getByTitle('Rotate')).not.toBeNull();
  });

  it('renders Scale gizmo button', () => {
    render(<MobileToolbar onToggleLeft={mockOnToggleLeft} onToggleRight={mockOnToggleRight} />);
    expect(screen.getByTitle('Scale')).not.toBeNull();
  });
  ...
  it('renders AddEntityMenu', () => {
    render(<MobileToolbar onToggleLeft={mockOnToggleLeft} onToggleRight={mockOnToggleRight} />);
    expect(screen.getByTestId('add-entity-menu')).not.toBeNull();
  });
