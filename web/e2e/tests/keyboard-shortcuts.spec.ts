...
test.describe('Keyboard Shortcuts @ui @dev', () => {
  ...
  test('W key activates Translate gizmo @engine-ui', async ({ page }) => {
  ...
  test('E key activates Rotate gizmo @engine-ui', async ({ page }) => {
    const canvas = page.locator('canvas').first();
    await canvas.click();
  ...
  test('R key activates Scale gizmo @engine-ui', async ({ page }) => {
    const canvas = page.locator('canvas').first();
    await canvas.click();
  ...
  test('Delete key does not crash with no selection @engine-ui', async ({ page }) => {
    const canvas = page.locator('canvas').first();
    await canvas.click();
  ...
  test('F2 key does not crash without entity selected @engine-ui', async ({ page }) => {
    const canvas = page.locator('canvas').first();
    await canvas.click();
  ...
  test('multiple rapid shortcut presses do not corrupt state @engine-ui', async ({ page }) => {
    const canvas = page.locator('canvas').first();
    await canvas.click();
