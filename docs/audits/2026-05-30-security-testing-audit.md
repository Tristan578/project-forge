...
| F10 | P1 | 🟠 medium | testing | e2e | No CI job runs @engine (WASM+GPU) tests; the real interactive journeys only run post-merge | `.github/workflows/ci.yml:300, .github/workflows/cd.yml:411` | #8602 |
