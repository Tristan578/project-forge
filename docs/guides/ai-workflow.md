...
## Overview
SpawnForge exposes all editor capabilities as MCP (Model Context Protocol) tools. AI assistants like Claude can use these tools to create scenes, modify entities, configure physics, write scripts, and more — all from natural language instructions.
...
3. Configure your AI client (Claude Desktop, Claude Code) to use the SpawnForge MCP server
