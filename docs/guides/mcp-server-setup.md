...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 310 of
the 368 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 368 commands by category.
...
For a complete list of all 368 commands with full parameter schemas, see:
