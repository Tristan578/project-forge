...
Use `list_doc_topics` or `search_docs` to discover the full set of 358 commands by category.
...
For a complete list of all 358 commands with full parameter schemas, see:
