...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 321 of
the 379 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 379 commands by category.
...
For a complete list of all 379 commands with full parameter schemas, see:
