...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 317 of
the 375 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 375 commands by category.
...
For a complete list of all 375 commands with full parameter schemas, see:
