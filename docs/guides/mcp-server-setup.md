...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 297 of
the 355 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 355 commands by category.
...
For a complete list of all 355 commands with full parameter schemas, see:
