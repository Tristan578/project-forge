...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 305 of
the 363 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 363 commands by category.
...
For a complete list of all 363 commands with full parameter schemas, see:
