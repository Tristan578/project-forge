...
the 362 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 362 commands by category.
...
For a complete list of all 362 commands with full parameter schemas, see:
