...
refused, with a one-click **Detach**. The bridge runs an **allowlist**: 309 of
the 367 commands are permitted by name, and anything not enumerated — including
...
Use `list_doc_topics` or `search_docs` to discover the full set of 367 commands by category.
...
For a complete list of all 367 commands with full parameter schemas, see:
