...
## Overview
SpawnForge supports skeletal animation playback from glTF/GLB files. Import an animated model, and its animation clips become available for playback, crossfading, and blending.
