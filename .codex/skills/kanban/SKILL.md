...
curl -s "http://localhost:3010/api/tickets?project=01KMM9ZA6SBZ7RKJZJTZS9VR4R" | python3 -m json.tool
curl -s "http://localhost:3010/api/tickets?project=01KMM9ZA6SBZ7RKJZJTZS9VR4R&status=todo" | python3 -m json.tool
